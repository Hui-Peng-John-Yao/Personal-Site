...
const GitHubLogo = () => (
  <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" style={{verticalAlign: 'middle'}}>
    ...
    <div className="project-section">
      ...
      <div className="project-info">
        ...
        <div className="project-tech-links">
          <span className="project-tech">{tech && tech.join('  ')}</span>
          {github && (
            <a href={github} target="_blank" rel="noopener noreferrer" className="project-link" title="GitHub">
              <GitHubLogo />
            </a>
          )}
          {external && (
            <a href={external} target="_blank" rel="noopener noreferrer" className="project-link" title="External Link">
